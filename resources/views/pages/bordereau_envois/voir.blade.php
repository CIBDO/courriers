    ...
    <div class="container">
        <div class="header">
            ...
            <p>ET DE LA COMPTABILITE PUBLIQUE </p>
              ...
              <br>
              <p style="margin-right: 50px;"><span class="right-align">Sikasso,le {{$bordereauEnvoi->date_bordereau->format('d F Y')}} </span></p>
              <br>
              <br>
              <br>
        ...
        <br>
        <br>
         <p class="signature1" style="margin-right: 100px; margin-bottom: 26px;"><span class="right-align"><u>{{$bordereauEnvoi->signataire->nom}}</u> </span></p>
